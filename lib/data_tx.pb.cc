...
namespace protobuf_data_5ftx_2eproto {
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "data_tx.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "data_tx.proto", &protobuf_RegisterTypes);
}
...
target_data::target_data()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_data_5ftx_2eproto::scc_info_target_data.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* target_data::descriptor() {
  ::protobuf_data_5ftx_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_data_5ftx_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const target_data& target_data::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_data_5ftx_2eproto::scc_info_target_data.base);
...
::google::protobuf::Metadata target_data::GetMetadata() const {
  protobuf_data_5ftx_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_data_5ftx_2eproto::file_level_metadata[kIndexInFileMessages];
}
